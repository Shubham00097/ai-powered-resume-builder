            ...
            >
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full text-sm px-3 py-2 rounded-lg resize-none border outline-none focus:ring focus:ring-purple-500 focus:border-purple-500 transition-colors"
